...
class Contants {
    ...
    public static final String videofolder = "D:\\考试\\计算机\\JKSJ 高级Java工程师体系课 2.0\\20 Spring 框架解读IOC流程";    // 需要被转换格式的视频目录

    public static final String targetfolder = "D:\\考试\\计算机\\JKSJ 高级Java工程师体系课 2.0\\20 Spring 框架解读IOC流程"; // 转码后视频保存的目录
